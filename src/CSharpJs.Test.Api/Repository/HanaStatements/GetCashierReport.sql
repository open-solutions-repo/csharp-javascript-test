SELECT
	TO_DOUBLE(V0."U_OPEN_CashCurrent") as "CashCurrent",
	COUNT(V1."DocEntry") as "SalesQuantity",
	TO_DOUBLE(COALESCE(SUM(V1."CashTotal"), 0)) as "CashTotal",
	TO_DOUBLE(COALESCE(SUM(V1."DebitCardTotal"), 0)) as "DebitCardTotal",
	TO_DOUBLE(COALESCE(SUM(V1."CreditCardTotal"), 0)) as "CreditCardTotal",
	TO_DOUBLE(COALESCE(SUM(V1."AccountCreditTotal"), 0)) as "AccountCreditTotal",
	TO_DOUBLE(COALESCE(SUM(V1."DocTotal"), 0)) as "SaleTotal"
